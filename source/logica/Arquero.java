...
public class Arquero extends Jugador {
	...
	public Arquero(int id, String n, String a, String e, int year, int month, int day,
			float p) {
	...
	public Arquero(int id, String string, String string2, String string3, Date date,
